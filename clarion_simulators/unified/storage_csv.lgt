%============================================================
% storage_csv.lgt - CSV File Storage Backend (Logtalk)
%
% Delegates core record operations to storage_memory,
% adds CSV file I/O with dirty-tracking.
%============================================================
...
:- object(storage_csv,
    ...
    create(file_state(Name,Pre,K,Fields,_,B,P,O), file_state(Name,Pre,K,Fields,[],B,P,O)) :-
        get_csv_path(Name, Name, FilePath),
    ...
    :- private([
        ...
        load_csv_records/3,
        save_csv_records/3,
        convert_rows_to_records/3,
        convert_records_to_rows/2,
    ...
    file_exists(FilePath) :-
        catch(exists_file(FilePath), _, fail).
